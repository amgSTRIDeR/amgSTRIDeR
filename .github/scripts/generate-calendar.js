...
function generateLanguages(languages, offsetX, offsetY, maxWidth) {
  ...
  sorted.forEach((lang, index) => {
    ...
    svg += `
      ...
      <text x="${startX + 16}" y="${y + 21}" font-family="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="13" fill="#CCCCCC" font-weight="700" letter-spacing="0.5">
        ${lang.name.toUpperCase()}
      </text>
      <text x="${x3 + 14}" y="${y + 21}" font-family="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="13" fill="#CCCCCC" font-weight="500">
...
function generateTechnologyStackSvg(techCounts, analyzedReposCount) {
  ...
  sorted.forEach((tech, index) => {
    ...
    bars += `
      <polygon points="${x1},${y} ${x2},${y} ${x3},${midY} ${x2},${bottomY} ${x1},${bottomY}" fill="${color}" />
      <text x="${startX + 16}" y="${y + 21}" font-family="Segoe UI, Roboto, Helvetica, Arial, sans-serif" font-size="13" fill="#CCCCCC" font-weight="700" letter-spacing="0.4">
        ${tech.name.toUpperCase()}
      </text>
      <text x="${x3 + 14}" y="${y + 21}" font-family="Segoe UI, Roboto, Helvetica, Arial, sans-serif" font-size="13" fill="#CCCCCC" font-weight="600">
